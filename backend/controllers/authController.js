...
export const getMe = async (req,  res) => {
  try {
    ...
    res.status(200).json({ success: true, message: "You are now logged in", user: {...user, password: undefined} });
  } catch (error) {
    res.status(400).json({ success: false, message: "Unable to get user account please try again" });
  }
}
